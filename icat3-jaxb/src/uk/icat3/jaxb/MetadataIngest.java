...
public class MetadataIngest {
     ...
     *
     */
    public static Long[] ingestMetadata(String userId, String xml, EntityManager manager) throws Exception {
        Icat icat = null;
    ...
    public static Long[] ingestMetadata(String userId, Icat icat, EntityManager manager) throws Exception {
