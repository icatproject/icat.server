...
public class TestRuleWhat {
	...
	public void testBad1() throws Exception {
		...
		try {
			...
			assertEquals("No more input expected at token INCLUDE in = TIMESTAMP < INCLUDE > ds.datafile.parameters , ", e.getMessage());
		}
	}
	...
	public void testGood1() throws Exception {
		...
		assertEquals(Dataset.class, sq.getBean());assertEquals(2, sq.getVarCount());
	...
	public void testGood2() throws Exception {
		...
		assertEquals(Dataset.class, sq.getBean());assertEquals(1, sq.getVarCount());
		assertNull(input.peek(0));
	}
