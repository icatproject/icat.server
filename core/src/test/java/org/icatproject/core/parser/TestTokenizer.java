...
public class TestTokenizer {
	...
	public void testGood1() throws Exception {
		List<Token> tokens = Tokenizer.getTokens("<-> investigation <-> investigator [facility_user_id = '$user']");
	...
	public void testTS() throws Exception {
		List<Token> tokens = Tokenizer.getTokens("{ts 1950-01-21 02:00:00} {  ts   1950-01-21   02:00:00      }");
