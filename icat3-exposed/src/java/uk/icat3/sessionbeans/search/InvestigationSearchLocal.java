...
public interface InvestigationSearchLocal {
	...
	// InvestigationInclude include, boolean fuzzy) throws SessionException ;
	 ...
	 * startIndex, int numberOfResults) throws SessionException ; Collection<Investigation>
	 * searchByKeywords(String sessionId, Collection<String> keywords, InvestigationInclude include,
	 * boolean fuzzy, int startIndex, int numberOfResults) throws SessionException ;
	 * Collection<Investigation> searchByKeywords(String sessionId, Collection<String> keywords,
	 * InvestigationInclude include, int startIndex, int numberOfResults) throws SessionException ;
	 * Collection<Investigation> searchByKeywords(String sessionId, Collection<String> keywords,
	 * LogicalOperator operator, InvestigationInclude include, boolean fuzzy, int startIndex, int
	 * numberOfResults) throws SessionException ;
	 */
	Collection<Investigation> searchByKeywords(String sessionId, KeywordDetails keywordDetails, int startIndex,
			int numberOfResults) throws SessionException;
