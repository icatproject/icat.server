...
public class ICAT extends EJBObject {
	...
	@WebParam Datafile datafile, @WebParam DatafileFormat datafileFormat,
			...
			@WebParam FacilityInstrumentScientist facilityInstrumentScientist, @WebParam FacilityUser facilityUser,
			...
			@WebParam Keyword keyword, @WebParam Parameter parameter, @WebParam Publication publication,
			@WebParam RelatedDatafiles relatedDatafiles, @WebParam Sample sample,
			@WebParam SampleParameter sampleParameter, @WebParam Shift shift,
			@WebParam SoftwareVersion softwareVersion, @WebParam Study study,
			@WebParam StudyInvestigation studyInvestigation, @WebParam StudyStatus studyStatus, @WebParam Topic topic,
			@WebParam TopicList topicList, @WebParam UserGroup userGroup, @WebParam Application application,
			@WebParam Job job, @WebParam InputDataset inputDataset, @WebParam OutputDataset outputDataset,
	...
	@WebMethod
	public void addUserGroupMember(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "groupName") String name, @WebParam(name = "memberName") String member)
			throws ObjectAlreadyExistsException, SessionException {
		ruleManagerLocal.addUserGroupMember(sessionId, name, member);
	}

	@WebMethod
	public void removeUserGroupMember(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "groupName") String name, @WebParam(name = "memberName") String member)
	...
	@WebMethod
	public long addRule(@WebParam(name = "sessionId") String sessionId, @WebParam(name = "groupName") String groupName,
			@WebParam(name = "what") String what, @WebParam(name = "crud") String crud,
			@WebParam(name = "restriction") String restriction) throws SessionException, IcatInternalException,
			BadParameterException {
		return ruleManagerLocal.addRule(sessionId, groupName, what, crud, restriction);
	}

	@WebMethod
	public void removeRule(@WebParam(name = "sessionId") String sessionId, @WebParam(name = "id") Long id)
	 ...
	 * keyword, they can only see keywords associated with their investigations
	...
	public Collection<String> getKeywordsForUser(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "startKeyword") String startKeyword, @WebParam(name = "numberReturned") int numberReturned)
			throws SessionException {
		return keywordSearchLocal.getKeywordsForUser(sessionId, startKeyword, numberReturned);
	}

	/**
	 * This gets all the keywords avaliable for that user that they can only see
	 * keywords associated with their investigations or public investigations
	 * 
	 * @param sessionId
	 *            federalId of the user.
	 ...
	 */
	@WebMethod
	public Collection<String> getAllKeywords(@WebParam(name = "sessionId") String sessionId,
	...
	// ///////////////////////// Investigation SearchManager methods
	// /////////////////////////////////////////
	/**
	...
	public Collection<Investigation> searchByAdvanced(@WebParam(name = "sessionId") String sessionId,
			...
			@WebParam(name = "startIndex") int startIndex, @WebParam(name = "numberOfResults") int numberOfResults)
			throws SessionException {
		return investigationSearchLocal.searchByAdvanced(sessionId, advancedSearch, startIndex, numberOfResults);
	}

	/**
	 * SearchManager by a collection of keywords for investigations that user has
	 * access to view, with AND been operator
	 * 
	 * @param sessionId
	 *            sessionId of the user.
	 * @param keywords
	 ...
	 * @param fuzzy
	 *            search with wildcards, e.g like copper searches for %copper%
	 *            i.e anything with copper in keyword, default false
	 ...
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsFuzzyAndInclude")
	 * 
	 * @ResponseWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsFuzzyAndIncludeResponse")
	 ...
	 * 
	 * @WebParam(name = "fuzzy") boolean fuzzy) throws SessionException { return
	 * investigationSearchLocal.searchByKeywords(sessionId, keywords,
	 * investigationIncludes, fuzzy); }
	 */
	/**
	 * SearchManager by a collection of keywords for investigations that user has
	 * access to view, with AND been operator, fuzzy false, no includes
	 * 
	 * @param sessionId
	 *            sessionId of the user.
	 * @param keywords
	...
	public Collection<Investigation> searchByKeywords(@WebParam(name = "sessionId") String sessionId,
	 ...
	 * 
	 * @RequestWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPagination")
	 * 
	 * @ResponseWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPaginationResponse") public
	 * Collection<Investigation> searchByKeywords(
	 * 
	 * @WebParam(name = "sessionId") String sessionId,
	 * 
	 * @WebParam(name = "keywords") Collection<String> keywords,
	 ...
	 * 
	 * @RequestWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPaginationFuzzyAndInclude")
	 * 
	 * @ResponseWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPaginationFuzzyAndIncludeResponse"
	 * ) public Collection<Investigation> searchByKeywords(
	 * 
	 * @WebParam(name = "sessionId") String sessionId,
	 * 
	 ...
	 * SessionException { return
	 * investigationSearchLocal.searchByKeywords(sessionId, keywords,
	 * investigationIncludes, fuzzy, startIndex, numberOfResults); }
	 */
	/**
	 * SearchManager by a collection of keywords for investigations that user has
	 * access to view, searching by fuzzy is true, with AND been operator
	 * 
	 * @param sessionId
	 *            sessionId of the user.
	 * @param keywords
	 ...
	 * 
	 * @RequestWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPaginationInclude")
	 * 
	 * @ResponseWrapper(className =
	 * "uk.icat3.sessionbeans.jaxws.searchByKeywordsPaginationIncludeResponse")
	 * public Collection<Investigation> searchByKeywords(
	 * 
	 * @WebParam(name = "sessionId") String sessionId,
	 * 
	 ...
	 * SessionException { return
	 * investigationSearchLocal.searchByKeywords(sessionId, keywords,
	 * investigationIncludes, startIndex, numberOfResults); }
	 */
	/**
	 * SearchManager by a collection of keywords for investigations that user has
	 * access to view
	...
	@Interceptors(KeywordsInterceptor.class)
	public Collection<Investigation> searchByKeywords(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "keywordDetails") KeywordDetails details, @WebParam(name = "startIndex") int startIndex,
	...
	public Collection<Investigation> getMyInvestigations(@WebParam(name = "sessionId") String sessionId)
			throws SessionException {
	...
	public Collection<Investigation> getMyInvestigations(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "investigationInclude") InvestigationInclude investigationIncludes,
			@WebParam(name = "startIndex") int startIndex, @WebParam(name = "numberOfResults") int number_results)
			throws SessionException {
		return investigationSearchLocal.getMyInvestigations(sessionId, investigationIncludes, startIndex,
				number_results);
	}
	 ...
	 */
	@WebMethod
	public Collection<Investigation> searchByUserID(@WebParam(name = "sessionId") String sessionId,
	...
	public Collection<Investigation> searchByUserID(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "userSearch") String userSearch, @WebParam(name = "startIndex") int startIndex,
	 ...
	 */
	@WebMethod
	public Collection<Investigation> searchByUserSurname(@WebParam(name = "sessionId") String sessionId,
	...
	public Collection<Investigation> searchByUserSurname(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "surname") String surname, @WebParam(name = "startIndex") int startIndex,
			@WebParam(name = "numberOfResults") int number_results) throws SessionException {
	 ...
	 */
	@WebMethod
	public Collection<Instrument> getAllInstruments(@WebParam(name = "sessionId") String sessionId)
			throws SessionException {
	 ...
	 */
	@WebMethod
	public List<Rule> listRules(@WebParam(name = "sessionId") String sessionId) throws SessionException {
	 ...
	 */
	@WebMethod
	public Collection<UserGroup> listUserGroups(@WebParam(name = "sessionId") String sessionId) throws SessionException {
	 ...
	 */
	@WebMethod
	public Collection<FacilityCycle> listFacilityCycles(@WebParam(name = "sessionId") String sessionId)
			throws SessionException {
	 ...
	 */
	@WebMethod
	public Collection<String> listInvestigationTypes(@WebParam(name = "sessionId") String sessionId)
			throws SessionException {
		return investigationSearchLocal.listInvestigationTypes(sessionId);
	}

	// ///////////////////////// End of Investigation SearchManager methods
	// /////////////////////////////////////////

	// ///////////////////////// Dataset SearchManager methods
	// /////////////////////////////////////////
	/**
	...
	public Collection<Sample> searchSamplesBySampleName(@WebParam(name = "sessionId") String sessionId,
	...
	@WebMethod
	@Interceptors(SampleSearchInterceptor.class)
	public Collection<Dataset> searchDatasetsBySample(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "sample") Sample sample) throws SessionException, NoSuchObjectFoundException,
	...
	// /////////////////////////////////////////
	/**
	 * Searchs database for data files from a start and end run on an instrument
	 * for which the userId has permission to read the data files investigation
	 * 
	 * @param sessionId
	 *            sessionId of the user.
	 * @param instruments
	...
	public Collection<Datafile> searchByRunNumber(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "instruments") Collection<String> instruments,
			@WebParam(name = "startRun") float startRun, @WebParam(name = "endRun") float endRun)
			throws SessionException {
	...
	public Collection<Datafile> searchByRunNumber(@WebParam(name = "sessionId") String sessionId,
			...
			@WebParam(name = "startIndex") int startIndex, @WebParam(name = "numberOfResults") int number_results)
			throws SessionException {
		return datafileSearchLocal.searchByRunNumber(sessionId, instruments, startRun, endRun, startIndex,
				number_results);
	}
	 ...
	 */
	@WebMethod
	public Collection<DatafileFormat> listDatafileFormats(@WebParam(name = "sessionId") String sessionId)
			throws SessionException {
		return datafileSearchLocal.listDatafileFormats(sessionId);
	}

	// ///////////////////////// End of Datafile SearchManager methods
	// /////////////////////////////////////////
	...
	public Investigation getInvestigation(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "investigationId") Long investigationId) throws SessionException,
	...
	public Investigation getInvestigation(@WebParam(name = "sessionId") String sessionId,
			...
			@WebParam(name = "investigationInclude") InvestigationInclude includes) throws SessionException,
			InsufficientPrivilegesException, NoSuchObjectFoundException {
	...
	public Collection<Investigation> getInvestigations(@WebParam(name = "userId") String userId,
			@WebParam(name = "investigationIds") Collection<Long> investigationIds) throws SessionException,
			InsufficientPrivilegesException, NoSuchObjectFoundException {
	 ...
	 * Returns a list of {@link Investigation} investigations from a list of
	 * {@link Investigation} investigation ids if the user has access to the
	 * investigations. Also gets extra information regarding the investigation.
	...
	public Dataset getDataset(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "datasetId") Long datasetId) throws SessionException, InsufficientPrivilegesException,
	...
	@Interceptors(ViewDatasetsInterceptor.class)
	public Dataset getDataset(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "datasetId") Long datasetId, @WebParam(name = "datasetInclude") DatasetInclude includes)
	...
	/**
	 * Gets the data set object from a from a list of data set ids, depending if
	...
	@WebMethod
	@Interceptors(ViewDatasetsInterceptor.class)
	public Collection<Dataset> getDatasets(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "datasetIds") Collection<Long> datasetIds) throws SessionException,
			InsufficientPrivilegesException, NoSuchObjectFoundException {
	...
	public Datafile getDatafile(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "datafileId") Long datafileId) throws SessionException, InsufficientPrivilegesException,
			NoSuchObjectFoundException {
		return datafileManagerLocal.getDatafile(sessionId, datafileId);
	}

	/**
	 * Gets a collection of data file object from a collection of data file ids,
	...
	@WebMethod
	@Interceptors(ViewDatafilesInterceptor.class)
	public Collection<Datafile> getDatafiles(@WebParam(name = "sessionId") String sessionId,
	...
	String downloadDatafiles(@WebParam(name = "sessionId") String sessionId,
			@WebParam(name = "datafileIds") Collection<Long> datafileIds) throws SessionException,
			NoSuchObjectFoundException, InsufficientPrivilegesException {
	 ...
	 */
	@WebMethod
	public Collection<Parameter> getParameterByNameUnits(@WebParam(name = "sesssionId") String sesssionId,
			@WebParam(name = "name") String name, @WebParam(name = "units") String units) throws SessionException {
		return parameterSearchLocal.getParameterByNameUnits(sesssionId, name, units);
	}

	/**
	 * Returns parameters matched by name. The search parameters are insensitive
	 * (no different between lowercase or uppercase) and eager (match the word,
	 * LIKE '%name%' behavior).
	 * 
	 * @param sessionId
	 *            Session identification
	 ...
	 */
	@WebMethod
	public Collection<Parameter> getParameterByName(@WebParam(name = "sessionId") String sessionId,
	...
	public Collection<Parameter> getParameterByUnits(@WebParam(name = "sessionId") String sessionId,
