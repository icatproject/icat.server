...
public class InvestigationSearchBean extends EJBObject implements InvestigationSearchLocal {
	...
	public Collection<Investigation> searchByAdvanced(String sessionId, AdvancedSearchDetails advancedSearch,
			int startIndex, int numberOfResults) throws SessionException {
	 ...
	 * @param include
	 *            Set of information to return with investigations, ie their keywords,
	 *            investigators, datasets, default none. Having more information returned means the
	...
	public Collection<Investigation> searchByKeywords(String sessionId, Collection<String> keywords,
	 ...
	 * "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsPaginationResponse") public
	 * Collection<Investigation> searchByKeywords(String sessionId, Collection<String> keywords, int
	 * startIndex, int numberOfResults) throws SessionException {
	 * 
	 * //for user bean get userId String userId = user.getUserIdFromSessionId(sessionId);
	 * 
	 * //now do the search using the API return InvestigationSearch.searchByKeywords(userId,
	 * keywords,LogicalOperator.AND, InvestigationInclude.NONE, false, SECURITY_ON, startIndex,
	 * numberOfResults, manager); }
	 */
	 ...
	 * 
	 * @ResponseWrapper(className=
	 * "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsPaginationAndFuzzyResponse") public
	 * Collection<Investigation> searchByKeywords(String sessionId, Collection<String> keywords,
	 * InvestigationInclude include, boolean fuzzy, int startIndex, int numberOfResults) throws
	 * SessionException {
	 * 
	 * //for user bean get userId String userId = user.getUserIdFromSessionId(sessionId);
	 * 
	 * //now do the search using the API, always use security return
	 * InvestigationSearch.searchByKeywords(userId, keywords,LogicalOperator.AND, include, fuzzy,
	 * SECURITY_ON, startIndex, numberOfResults, manager); }
	 */
	 ...
	 * "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsPaginationFuzzyAndInclude")
	 * 
	 * @ResponseWrapper(className=
	 * "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsPaginationFuzzyAndIncludeResponse")
	 * public Collection<Investigation> searchByKeywords(String sessionId, Collection<String>
	 * keywords, InvestigationInclude include, int startIndex, int numberOfResults) throws
	 * SessionException {
	 * 
	 * //for user bean get userId String userId = user.getUserIdFromSessionId(sessionId);
	 * 
	 * //now do the search using the API, always use security return
	 * InvestigationSearch.searchByKeywords(userId, keywords,LogicalOperator.AND, include, false,
	 * SECURITY_ON, startIndex, numberOfResults, manager); }
	 */
	 ...
	 * public Collection<Investigation> searchByKeywords(String sessionId, Collection<String>
	 * keywords, LogicalOperator operator, InvestigationInclude include, boolean fuzzy, int
	 * startIndex, int numberOfResults) throws SessionException {
	 * 
	 * //for user bean get userId String userId = user.getUserIdFromSessionId(sessionId);
	 * 
	 * //now do the search using the API, always use security return
	 * InvestigationSearch.searchByKeywords(userId, keywords, operator, include, fuzzy, SECURITY_ON,
	 * startIndex, numberOfResults, manager); }
	 */
	...
	@RequestWrapper(className = "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsAll")
	@ResponseWrapper(className = "uk.icat3.sessionbeans.search.jaxws.searchByKeywordsAllResponse")
	public Collection<Investigation> searchByKeywords(String sessionId, KeywordDetails keywordDetails, int startIndex,
	...
	public Collection<Investigation> getMyInvestigations(String sessionId, InvestigationInclude include)
			throws SessionException {
	...
	public Collection<Investigation> getMyInvestigations(String sessionId, InvestigationInclude include,
			int startIndex, int number_results) throws SessionException {
	...
	public Collection<Investigation> searchByUserID(String sessionId, String userSearch, int startIndex,
	...
	public Collection<Investigation> searchByUserSurname(String sessionId, String surname, int startIndex,
			int number_results) throws SessionException {
