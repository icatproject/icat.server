...
public class Token {
	...
	public enum Type {
		...
		DESC, DISTINCT, DIV, EMPTY, ESCAPE, FALSE, FETCH, FROM, GROUP, HAVING, IN, INNER, IS, JOIN, LEADING, LEFT, LENGTH, LOCATE,

		LOWER, MAX, MEMBER, MIN, MINUS, MOD, MULT, NOT, NULL, OBJECT, OR, ORDER, OUTER, PLUS, REAL, SELECT, SIZE, SQRT, SUBSTRING,
