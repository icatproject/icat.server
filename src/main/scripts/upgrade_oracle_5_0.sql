...
CREATE TABLE INVESTIGATIONFACILITYCYCLE (
	...
	MOD_ID VARCHAR2(255) NOT NULL, 
	MOD_TIME TIMESTAMP NOT NULL, 
	FACILITYCYCLE_ID NUMBER(19) NOT NULL, 
	INVESTIGATION_ID NUMBER(19) NOT NULL, 
	PRIMARY KEY (ID)
);

ALTER TABLE INVESTIGATIONFACILITYCYCLE ADD CONSTRAINT NVSTGTNFACILITYCYCLENVSTGTONID FOREIGN KEY (INVESTIGATION_ID) REFERENCES INVESTIGATION (ID);
ALTER TABLE INVESTIGATIONFACILITYCYCLE ADD CONSTRAINT NVSTGTNFACILITYCYCLEFCLTYCYCLD FOREIGN KEY (FACILITYCYCLE_ID) REFERENCES FACILITYCYCLE (ID)
ALTER TABLE INVESTIGATIONFACILITYCYCLE ADD CONSTRAINT INVESTIGATIONFACILITYCYCLE0 UNIQUE (FACILITYCYCLE_ID, INVESTIGATION_ID);
