...
BEGIN
    UPDATE SAMPLE SET PID = CONCAT('local:', ID) WHERE PID IS NULL;
END; //
...
BEGIN
    ...
    DECLARE _invid BIGINT UNSIGNED;
    ...
    sampleLoop: LOOP
        ...
        INSERT INTO INVESTIGATIONSAMPLE (CREATE_ID, CREATE_TIME, MOD_ID, MOD_TIME, INVESTIGATION_ID, SAMPLE_ID) VALUES (_id, NOW(), _id, NOW(), _invid, _id);
    END LOOP sampleLoop;
    CLOSE cur;
END; //
