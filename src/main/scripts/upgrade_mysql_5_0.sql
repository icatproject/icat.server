...
ALTER TABLE DATAPUBLICATIONTYPE ADD CONSTRAINT FK_DATAPUBLICATIONTYPE_FACILITY_ID FOREIGN KEY (FACILITY_ID) REFERENCES FACILITY (ID);
...
ALTER TABLE DATAPUBLICATION ADD CONSTRAINT FK_DATAPUBLICATION_DATAPUBLICATIONTYPE_ID FOREIGN KEY (DATAPUBLICATIONTYPE_ID) REFERENCES DATAPUBLICATIONTYPE (ID);
...
ALTER TABLE DATACOLLECTIONINVESTIGATION ADD CONSTRAINT FK_DATACOLLECTIONINVESTIGATION_INVESTIGATION_ID FOREIGN KEY (INVESTIGATION_ID) REFERENCES INVESTIGATION (ID);
ALTER TABLE DATACOLLECTIONINVESTIGATION ADD CONSTRAINT FK_DATACOLLECTIONINVESTIGATION_DATACOLLECTION_ID FOREIGN KEY (DATACOLLECTION_ID) REFERENCES DATACOLLECTION (ID);
ALTER TABLE DATACOLLECTIONINVESTIGATION ADD CONSTRAINT UNQ_DATACOLLECTIONINVESTIGATION_0 UNIQUE (DATACOLLECTION_ID, INVESTIGATION_ID);
...
ALTER TABLE INVESTIGATIONFACILITYCYCLE ADD CONSTRAINT UNQ_INVESTIGATIONFACILITYCYCLE_0 UNIQUE (FACILITYCYCLE_ID, INVESTIGATION_ID);
