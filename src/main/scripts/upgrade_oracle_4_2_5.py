...
def change():
    ...
    cur.execute("CREATE TABLE DATACOLLECTIONPARAMETER (ID NUMBER(19) NOT NULL, CREATE_ID VARCHAR2(255) NOT NULL, CREATE_TIME TIMESTAMP NOT NULL, DATETIME_VALUE TIMESTAMP NULL, ERROR NUMBER(38,19) NULL, MOD_ID VARCHAR2(255) NOT NULL, MOD_TIME TIMESTAMP NOT NULL, NUMERIC_VALUE NUMBER(38,19) NULL, RANGEBOTTOM NUMBER(38,19) NULL, RANGETOP NUMBER(38,19) NULL, STRING_VALUE VARCHAR2(4000) NULL, DATACOLLECTION_ID NUMBER(19) NOT NULL, PARAMETER_TYPE_ID NUMBER(19) NOT NULL, PRIMARY KEY (ID))")
    ...
    cur.execute("ALTER TABLE SAMPLETYPE MODIFY MOLECULARFORMULA VARCHAR2(511) NOT NULL")
