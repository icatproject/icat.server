...
public class TestEntityInfo {
	...
	public void testFields() throws Exception {
		...
		testField(
				...
				Investigation.class);
		testField("complete,dataCollectionDatasets,datafiles,description,doi,endDate,fileCount,"
				+ "investigation,location,name,parameters,sample,size,startDate,type", Dataset.class);
