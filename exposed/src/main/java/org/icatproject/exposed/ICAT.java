...
public class ICAT {
	...
	public void refresh(@WebParam(name = "sessionId") String sessionId) throws IcatException {
		beanManagerBean.refresh(sessionId);
	}
