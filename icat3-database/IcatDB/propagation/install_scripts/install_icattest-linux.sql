...
REM - migration from v2 to v3 not needed
REM - icat authorisation now done by a trigger
REM - this needs adding at some stage - taking it from the production system
