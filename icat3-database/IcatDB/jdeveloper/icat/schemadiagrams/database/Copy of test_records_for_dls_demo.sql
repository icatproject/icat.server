...
values
(INVESTIGATION_ID_SEQ.nextval, 'sp123', '1', 'nessie', 'Monte Carlo Computational Steering',
 'various slicings and dicings', 'experiment', systimestamp, 'icat-test-records', 'icat-test-records','N') ;

-- keywords

insert into keyword (investigation_id, name, mod_time, mod_id, create_id, deleted)
values
((select id from investigation where inv_number = 'sp123' and visit_id = '1' and instrument = 'nessie'), 'Monte Carlo',
 systimestamp, 'icat-test-records', 'icat-test-records', 'N') ;


insert into keyword (investigation_id, name, mod_time, mod_id, create_id, deleted)
values
((select id from investigation where inv_number = 'sp123' and visit_id = '1' and instrument = 'nessie'), 'Slicing',
 systimestamp, 'icat-test-records', 'icat-test-records', 'N') ;
   

insert into keyword (investigation_id, name, mod_time, mod_id, create_id, deleted)
values
((select id from investigation where inv_number = 'sp123' and visit_id = '1' and instrument = 'nessie'), 'Dicing',
 systimestamp, 'icat-test-records', 'icat-test-records', 'N') ;
