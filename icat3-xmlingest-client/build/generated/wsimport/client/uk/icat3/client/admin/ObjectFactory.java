 ...
 * generated in the uk.icat3.client.admin package. 
...
public class ObjectFactory {
    ...
    private final static QName _LoginAdmin_QNAME = new QName("admin.client.icat3.uk", "loginAdmin");
    private final static QName _SessionException_QNAME = new QName("admin.client.icat3.uk", "SessionException");
    private final static QName _LoginAdminResponse_QNAME = new QName("admin.client.icat3.uk", "loginAdminResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uk.icat3.client.admin
     * 
     */
