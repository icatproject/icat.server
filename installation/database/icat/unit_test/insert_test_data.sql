...
Insert into INVESTIGATION
 ...
 Values
   (3, '12345', '12', 'ISIS', 15, 'test abstract', 'MAPS', 'Investigation without any investigators', 'experiment', 'damian', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
...
Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID, FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (5, '1f452', '13', 'ISIS', 'CRISP', 'Investigation not FA', 'experiment', 'gjd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');


Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID,  FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (6, '232323', 'ddd13', 'ISIS', 'MAPS', 'Investigation, not readable', 'experiment', 'gjdd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');

Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID, FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (7, '232323', 'deletable', 'ISIS', 'MAPS', 'Investigation deleable', 'experiment', 'gjdd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');
...
Insert into ICAT_AUTHORISATION
 ...
 Values
   (-1, 'test', 'ADMIN', 'INVESTIGATION', TO_TIMESTAMP('27/08/2008 16:15:45.0','DD/MM/YYYY HH24:MI:SS.FF'), 'overlord', TO_TIMESTAMP('27/08/2008 16:15:45.0','DD/MM/YYYY HH24:MI:SS.FF'), 'overlord', 'N', 'N');
