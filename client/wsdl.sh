...
wget --no-proxy --no-check-certificate https://$host:$port/ICATService/ICAT?wsdl -O ICAT.wsdl
wget --no-proxy --no-check-certificate https://$host:$port/ICATService/ICAT?xsd=1 -O ICAT.xsd
...
wget --no-proxy --no-check-certificate https://$host:$port/ICATCompatService/ICATCompat?wsdl -O ICATCompat.wsdl
wget --no-proxy --no-check-certificate https://$host:$port/ICATCompatService/ICATCompat?xsd=1 -O ICATCompat.xsd
