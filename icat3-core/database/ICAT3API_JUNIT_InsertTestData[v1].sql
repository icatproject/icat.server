...
Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID, FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (5, '1f452', '13', 'ISIS', 'GEM', 'Investigation not FA', 'experiment', 'gjd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');
...
Insert into INVESTIGATION
 ...
 Values
   (8, '543', 'NT449-1', TO_TIMESTAMP('02/01/2008 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), 'This is a test abstract for the dataportal demo','Run number range', '2300 - 2400', 'ISIS', 'SXD', 'cycle_00_1', 'Powder Diffraction 1459GPa', 'experiment', 'gjd37', TO_TIMESTAMP('02/01/2008 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');
...
Insert into DATAFILE
 ...
 Values
   (2, 2, 'SXD01064.RAW', 'SrF2 calibration w=-25.3', 'file://d', 2430976, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION,  LOCATION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (58, 2, 'SXD01256.RAW', 'SrF2 calibration (00l)', 'file://d', 6024704, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION,  LOCATION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (81, 2, 'SXD01300.RAW', 'SrF2 position calibration', 'file://d', 3169280, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
   (ID, DATASET_ID, NAME,  LOCATION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (17434, 2, 'SXD01300.LOG','file://d', 227, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
...
Insert into DATAFILE
 ...
 Values
   (3, 3, 'SXD015554.RAW', 'SrF3 calibration w=-288.3', 'file://d', 345, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), systimestamp, 'N', 'N');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION,   LOCATION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (57, 3, 'SXD0155.RAW', 'SrF3 calibration (1100l)', 'file://d', 6000000, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION,  LOCATION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
