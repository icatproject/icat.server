...
Insert into INVESTIGATION
 ...
 Values
   (3, '12345', '12', 'ISIS', 15, 'test abstract', 'SXD', 'Investigation without any investigators', 'experiment', 'damian', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
...
Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID, FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (6, '232323', 'ddd13', 'ISIS', 'SXD', 'Investigation, not readable', 'experiment', 'gjdd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');

Insert into INVESTIGATION
   (ID, INV_NUMBER, VISIT_ID, FACILITY, INSTRUMENT, TITLE, INV_TYPE, BCAT_INV_STR, RELEASE_DATE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (7, '232323', 'deletable', 'ISIS', 'SXD', 'Investigation deleable', 'experiment', 'gjdd37', TO_TIMESTAMP('02/01/2009 00:00:00.0','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:39:59.1','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');
...
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (81, 2, 'SXD01300.RAW', 'SrF2 position calibration', 3169280, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
...
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, DATAFILE_CREATE_TIME, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (3, 3, 'SXD015554.RAW', 'SrF3 calibration w=-288.3', 345, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), systimestamp, 'N', 'N');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (57, 3, 'SXD0155.RAW', 'SrF3 calibration (1100l)', 6000000, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (56, 3, 'deleted.RAW', 'SrF3 calibration (1100l)', 6000, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'Y', 'N');

Insert into DATAFILE
   (ID, DATASET_ID, NAME, DESCRIPTION, FILE_SIZE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (60, 6, 'deletable.RAW', 'SrF3 calibration (1100l)', 6000, TO_TIMESTAMP('02/01/2007 11:44:45.8','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'N');
...
Insert into DATAFILE_PARAMETER
   (DATAFILE_ID, NAME, UNITS, STRING_VALUE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
   (81, 'run_header', 'N/A', 'SXD01300                /ccwSrF2 position calibratio 2-OCT-1989 07:16:12    89.6', TO_TIMESTAMP('02/01/2007 11:52:56.3','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', systimestamp, 'N', 'Y');
Insert into DATAFILE_PARAMETER
   (DATAFILE_ID, NAME, UNITS, NUMERIC_VALUE, MOD_TIME, MOD_ID, CREATE_ID, CREATE_TIME, DELETED, FACILITY_ACQUIRED)
 Values
...
Insert into FACILITY_INSTRUMENT_SCIENTIST Values
  ('SXD', 'facility_scientist', 1, TO_TIMESTAMP('02/01/2007 11:52:56.3','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', systimestamp, 'FIRST PROPAGATION', 'N', 'N');
Insert into FACILITY_INSTRUMENT_SCIENTIST Values
  ('MUSR', 'none_facility_scientist', 1, TO_TIMESTAMP('02/01/2007 11:52:56.3','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', systimestamp, 'FIRST PROPAGATION', 'N', 'N');
Insert into FACILITY_INSTRUMENT_SCIENTIST Values
  ('SXD', 'deleted_facility_scientist', 1, TO_TIMESTAMP('02/01/2007 11:52:56.3','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', systimestamp, 'FIRST PROPAGATION', 'N', 'Y');
