...
FACILITY_AQUIRED VARCHAR2(1) DEFAULT 'Y' NOT NULL,
...
CREATE_TIME TIMESTAMP(1) NOT NULL,
CREATE_ID VARCHAR2(255) NOT NULL,
FACILITY_AQUIRED VARCHAR2(1) NOT NULL,
DELETED VARCHAR2(1) DEFAULT 'N' NOT NULL
)
;
...
CREATE_TIME TIMESTAMP(1) NOT NULL,
CREATE_ID VARCHAR2(255) NOT NULL,
FACILITY_AQUIRED VARCHAR2(4000) NOT NULL,
DELETED VARCHAR2(1) DEFAULT 'N' NOT NULL
)
;
...
ALTER TABLE ICAT_AUTHORISATION 
ADD CONSTRAINT ICAT_AUTHORISATION_INVEST_FK1 FOREIGN KEY
(
INVESTIGATION_ID
)
REFERENCES INVESTIGATION
...
COMMENT ON COLUMN APPLICATIONS.FACILITY_AQUIRED IS 'added for consistency'
;
...
COMMENT ON COLUMN USER_ROLES.FACILITY_AQUIRED IS 'added to this table for consistency'
;
