...
insert into "THIS_ICAT" 
    (FACILITY_SHORT_NAME, FACILITY_LONG_NAME ,FACILITY_URL ,FACILITY_DESCRIPTION ,MOD_ID VARCHAR2, MOD_TIME,CREATE_ID , CREATE_TIME,DELETED,FACILITY_ACQUIRED)  
...
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('ADMIN',      9, 'Y', 1,  'Y', 15, 'Y', 5, 'Y', 10, 'Y', 20, 'Y', 25, 'Y', 50, 'N', 50 ,'N', 50, 'Y', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('CREATOR',    8, 'Y', 1,  'Y', 15, 'Y', 5, 'Y', 10, 'Y', 20, 'N', 25, 'Y', 50, 'N', 50, 'N', 50, 'Y', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('DELETER',    7, 'N', 1,  'Y', 15, 'Y', 5, 'Y', 10, 'Y', 20, 'N', 25, 'N', 50, 'N', 50, 'N', 50, 'N', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('DOWNLOADER', 5, 'N', 1,  'Y', 15, 'Y', 5, 'N', 10, 'N', 20, 'N', 25, 'N', 50, 'N', 50, 'N', 50, 'N', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('ICAT_ADMIN',10, 'Y', 1,  'Y', 15, 'Y', 5, 'Y', 10, 'Y', 20, 'Y', 25, 'Y', 50, 'Y', 50, 'Y', 50, 'Y', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('READER',     4, 'N', 1,  'Y', 15, 'N', 5, 'N', 10, 'N', 20, 'N', 25, 'N', 50, 'N', 50 ,'N', 50, 'N', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
insert into ICAT_ROLE 
(ROLE ,ROLE_WEIGHT ,ACTION_INSERT ,ACTION_INSERT_WEIGHT ,ACTION_SELECT  ,ACTION_SELECT_WEIGHT,ACTION_DOWNLOAD ,ACTION_DOWNLOAD_WEIGHT ,ACTION_UPDATE ,ACTION_UPDATE_WEIGHT ,
ACTION_DELETE ,ACTION_DELETE_WEIGHT ,ACTION_REMOVE ,ACTION_REMOVE_WEIGHT ,ACTION_ROOT_INSERT ,ACTION_ROOT_INSERT_WEIGHT ,ACTION_ROOT_REMOVE ,ACTION_ROOT_REMOVE_WEIGHT ,
ACTION_SET_FA ,ACTION_SET_FA_WEIGHT ,ACTION_MANAGE_USERS ,ACTION_MANAGE_USERS_WEIGHT,MOD_TIME ,MOD_ID ,CREATE_TIME ,CREATE_ID ,FACILITY_ACQUIRED ,DELETED ) 
values ('UPDATER',    6, 'N', 1,  'Y', 15, 'Y', 5, 'Y', 10, 'N', 20, 'N', 25, 'N', 50, 'N', 50 ,'N', 50, 'N', 50, systimestamp,'glen',systimestamp,'glen','Y','N');
...
Insert into INSTRUMENT
   (NAME, TYPE, DESCRIPTION,  MOD_TIME, CREATE_TIME, MOD_ID, CREATE_ID, DELETED, FACILITY_ACQUIRED)
 Values
   ('DEVA', 'Muon', 'DEVA', TO_TIMESTAMP('02/01/2007 11:25:13.9','DD/MM/YYYY HH24:MI:SS.FF'),TO_TIMESTAMP('02/01/2007 11:25:14.7','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'FIRST PROPAGATION', 'N', 'Y');
...
Insert into PARAMETER
 ...
 Values
   ('finish_date', 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm:ss', 'Y', 'N', 'Y', 'Y', 'Y', 'FIRST PROPAGATION', TO_TIMESTAMP('02/01/2007 11:32:57.5','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:25:14.7','DD/MM/YYYY HH24:MI:SS.FF'),'FIRST PROPAGATION', 'N', 'Y');
Insert into PARAMETER
   (NAME, UNITS, UNITS_LONG_VERSION, SEARCHABLE, NUMERIC_VALUE, IS_SAMPLE_PARAMETER, IS_DATASET_PARAMETER, IS_DATAFILE_PARAMETER, MOD_ID,  MOD_TIME, CREATE_TIME, CREATE_ID, DELETED, FACILITY_ACQUIRED)
 Values
...
Insert into PARAMETER
 ...
 Values
   ('run_number', 'N/A', 'Y', 'Y', 'U', 'U', 'Y', 'Other possible name : shot_number', 'FIRST PROPAGATION', TO_TIMESTAMP('02/01/2007 11:25:15.6','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:25:14.7','DD/MM/YYYY HH24:MI:SS.FF'),'FIRST PROPAGATION', 'N', 'Y');
Insert into PARAMETER
   (NAME, UNITS, UNITS_LONG_VERSION, SEARCHABLE, NUMERIC_VALUE, IS_SAMPLE_PARAMETER, IS_DATASET_PARAMETER, IS_DATAFILE_PARAMETER, MOD_ID,  MOD_TIME, CREATE_TIME, CREATE_ID, DELETED, FACILITY_ACQUIRED)
 Values
...
Insert into PARAMETER
   (NAME, UNITS, UNITS_LONG_VERSION, SEARCHABLE, NUMERIC_VALUE, IS_SAMPLE_PARAMETER, IS_DATASET_PARAMETER, IS_DATAFILE_PARAMETER, MOD_ID, MOD_TIME, CREATE_TIME, CREATE_ID, FACILITY_ACQUIRED, DELETED)
 Values
   ('time_zero', 'microseconds', 'microseconds', 'Y', 'Y', 'Y', 'Y', 'Y', 'FIRST PROPAGATION', TO_TIMESTAMP('02/01/2007 11:32:57.5','DD/MM/YYYY HH24:MI:SS.FF'), TO_TIMESTAMP('02/01/2007 11:25:14.7','DD/MM/YYYY HH24:MI:SS.FF'), 'FIRST PROPAGATION', 'Y', 'N');
