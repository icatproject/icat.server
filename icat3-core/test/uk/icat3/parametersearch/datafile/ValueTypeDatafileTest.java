 ...
 * @author cruzcruz
 */
public class ValueTypeDatafileTest extends BaseParameterSearchTest {

    /**
     * Test Between comparator search
     *
     * @throws ParameterSearchException, RestrictionException
     */
    @Test
...
//        comp1.setValueRight(new Double (4));
    ...
    public static junit.framework.Test suite(){
        return new JUnit4TestAdapter(ValueTypeDatafileTest.class);
    }
}
